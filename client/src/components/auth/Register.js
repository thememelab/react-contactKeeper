        ...
        <div className= "form-container">
            ...
            Account <span className="text-primary">Register </span>
             ...
             <div className="form-group">
                ...
                <input type="password" name="password" value={password} onChange={onChange} minLength="6"></input>
             </div>
             <div className="form-group">
                <label htmlFor="password2"> Confirm Password </label>
                <input type="password" name="password2" value={password2} onChange={onChange} minLength="6" ></input>
             </div>
